...
## References
- The code to control the AD4351 module with the Arduio Uno microcontroller is readapted from a code written by Alain Fort F1CJN. The original code can be downloaded here: http://f6kbf.free.fr/html/ADF4351%20and%20Arduino_Fr_Gb.htm
